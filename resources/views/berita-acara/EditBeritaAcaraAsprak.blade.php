                ...
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        <input type="date" class="form-control input-tanggal" id="tanggal" name="tanggal"
                            value="{{ isset($beritaAcara->tanggal_kegiatan) ? \Carbon\Carbon::parse($beritaAcara->tanggal_kegiatan)->format('Y-m-d') : old('tanggal') }}" required>
                        </input>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="upload-card">
                        <label for="input-file-beritaAcara" class="file-upload-label">
                            ...
                            Masukkan File
                            <input type="file" class="file-upload-input @error('file-input-beritaAcara') is-invalid @enderror" id="input-file-beritaAcara" name="file-input-beritaAcara" accept=".pdf" @if(isset($submitText) && $submitText === 'Update') @else required @endif>
                        </label>
                ...
                <div class="form-group" id="uploadContainer" style="display: none;">
                    ...
                    <div class="upload-card">
                        <label for="input-file-buktiPertemuan" class="file-upload-label">
                            <img src="{{ asset('img/IconUpload.png') }}" alt="icon-upload" class="icon-upload">
                            Masukkan File
                            <input type="file" class="file-upload-input @error('file-input-buktiPertemuan') is-invalid @enderror" id="input-file-buktiPertemuan" name="file-input-buktiPertemuan" accept=".pdf,.jpg,.jpeg,.png" @if(isset($submitText) && $submitText === 'Update') @else required @endif>
                        </label>
